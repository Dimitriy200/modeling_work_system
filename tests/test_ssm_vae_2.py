...
# ОБЩИЕ ПАРАМЕТРЫ
# ------------------------------
PATH_IMG_SSM = os.path.join(PATH_IMG, "ssm_vae")
PATH_TRAIN_PROCESSED_SSM = os.path.join(PATH_TRAIN_PROCESSED, "experiments")
...
if LOAD_MODEL:
    ...
    plot_vae_training_history(history, save_path=os.path.join(PATH_IMG_SSM, f"plot_history_{MODEL_NAME}_{MODEL_VERSION}.png"))
...
for engine_idx in range(num_engines_to_plot):
    ...
    current_save_path = os.path.join(PATH_IMG_SSM, f"plot_inf_norm_{MODEL_NAME}_{MODEL_VERSION}_eng_{engine_idx}.png")
...
plot_recursive_lifetime_forecast(
    ...
    num_scenarios = 3,
    save_path = os.path.join(PATH_IMG_SSM, f"plot_inf_ft_norm_eng({ENGINE_N})_eng_{MODEL_NAME}.png")
)
...
for engine_idx in range(num_engines_to_plot):
    ...
    # 3. Формируем уникальное имя файла для каждого двигателя (например, engine_0.png, engine_1.png...)
    current_save_path = os.path.join(PATH_IMG_SSM, f"plot_inf_norm_drop_{MODEL_NAME}_{MODEL_VERSION}_eng_{engine_idx}.png")
...
plot_recursive_lifetime_forecast(
    ...
    feature_name = "sensor measurement 9",
    num_scenarios = 3,
    save_path = os.path.join(PATH_IMG_SSM, f"plot_inf_ft_norm_drop_eng({ENGINE_N})_eng_{MODEL_NAME}.png")
)
...
for engine_idx in range(num_engines_to_plot):
    ...
    # 3. Формируем уникальное имя файла для каждого двигателя (например, engine_0.png, engine_1.png...)
    current_save_path = os.path.join(PATH_IMG_SSM, f"plot_inf_norm_noise_{MODEL_NAME}_{MODEL_VERSION}_eng_{engine_idx}.png")
...
plot_recursive_lifetime_forecast(
    ...
    feature_name = "sensor measurement 9",
    num_scenarios = 3,
    save_path = os.path.join(PATH_IMG_SSM, f"plot_inf_ft_norm_noise_eng({ENGINE_N})_eng_{MODEL_NAME}.png")
)
...
for engine_idx in range(num_engines_to_plot):
    ...
    # 3. Формируем уникальное имя файла для каждого двигателя (например, engine_0.png, engine_1.png...)
    current_save_path = os.path.join(PATH_IMG_SSM, f"plot_inf_norm_both_{MODEL_NAME}_{MODEL_VERSION}_eng_{engine_idx}.png")
